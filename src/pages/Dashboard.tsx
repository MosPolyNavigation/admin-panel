...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        const response = await get_all_stats(filterType, requestStartDate, requestEndDate, token);
  ...
  return (
    <Page headerText={'Дашборды'}>
      <Stack sx={{ gap: 2 }}>
        <Card>
          <DateSelectors dateInterval={dateInterval} onDateIntervalChange={setDateInterval} />
        </Card>
